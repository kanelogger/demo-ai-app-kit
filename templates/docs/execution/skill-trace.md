...
> Generated from demo-ai-app-kit. Fill this in while executing the workflow.
> This file turns skill routing from advice into a checkable process record.
> Language policy: when completing this file, infer the user's native/dominant
> language from the requirement and rewrite human-facing notes in that language.
> Keep skill names, file paths, commands, and machine-readable status values in English.
...
Record any skipped skill, merged step, or changed order. Every deviation needs a concrete reason.

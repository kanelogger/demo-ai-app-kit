...
让 `kit init` 生成一个带完整 Agent 控制面的项目骨架，且 fresh project 能通过 `kit check` 的 `initialized` 阶段校验。
...
* Add frontend/backend `SPECS/README.md` listing `PRD.md`, `ARCHITECTURE.md`, `API.md`, `FEATURES/<feature-slug>.md`.
...
* Generating real feature `SPECS/PRD.md`, `ARCHITECTURE.md`, or `FEATURES/*.md`.

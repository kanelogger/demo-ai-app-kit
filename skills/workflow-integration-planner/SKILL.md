...
1. Identify the user action that triggers AI.
2. Define the workflow purpose in one sentence.
3. Define request JSON from local app to workflow.
4. Define response JSON from workflow to local app.
5. Define mock response with the exact same response shape.
6. Define timeout, retry, empty result, unsafe result, and platform unavailable behavior.
7. Define environment variables and where they are documented.

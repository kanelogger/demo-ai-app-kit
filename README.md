...
刚生成的目录是待 Agent 填充的工作区，不是开箱即过的完成品。此时 Flask 模板可以启动，但 `docs/requirements.md`、`docs/tech-plan.md`、`docs/workflow-integration.md`、`docs/test-report.md` 仍是占位骨架；只有 Agent 完成需求、技术方案、workflow 文档、测试报告和 README 更新后，generated app 才应该通过 `./bin/check-demo .`。
